...
The USRCLASS.DAT hive is located in the directory C:\Users\<username>\AppData\Local\Microsoft\Windows. "in the image shown, the userClass.dat file is a hidden file"

The NTUSER.DAT hive is located in the directory C:\Users\<username>\.  "the NTUSER.DAT file is also a hidden file"
...
have to download the image since i cant copy paste and im not downloading lol
...
![[registry_explore.png]]

cant get images to work atm so 
the image is showing a dir \currentversion 
and is giving information of the OS
...
![[Pasted image 20240503211010.png]]
...
Here, the 15.0 refers to Office 2013. A list of different Office releases and their version numbers can be found on [this link](https://learn.microsoft.com/en-us/deployoffice/install-different-office-visio-and-project-versions-on-the-same-computer#office-releases-and-their-version-number)
...
![[Pasted image 20240503211805.png]]
...
![[Pasted image 20240503212125.png]]
...
What is the Absolute Path of the file opened using notepad.exe?\
	C:\programs files\amazon\ec2configservic\setting
...
![[Pasted image 20240503212638.png]]
...
![[Pasted image 20240503213100.png]]
...
![[Pasted image 20240503213228.png]]
...
![[Pasted image 20240503213346.png]]
...
![[Pasted image 20240503214249.png]]
...
![[Pasted image 20240503215004.png]]
...
"took an hour to figure this out but you have to use eric zimmers tool the Registry explorer and load the logs, but some of the logs are dirty so you have to go through a process of cleaning them then loading the cleaned log. ill leave a link to where this is explained."

##########################################################################

Write up

so i got stuck on how to use the registry explore tool, also the logs were "dirty" so we had to get the clean logs by combining log 1 and 2, what that did was reference the "dirty" logs with the 1 and 2 and output all the data.

had to repeat this process for all the logs, after we got all the proper logs loading in the explorer tool and I was able to view all the information that was being asked in the questions.
...
What is the complete path from where the python 3.8.2 installer was run? 
	App Id Z:\setups\python-3.8.2.exe

When was the USB device with the friendly name 'USB' last connected?
	2021-11-24 18:40:06

next time lets get pictures of where we found the answers.